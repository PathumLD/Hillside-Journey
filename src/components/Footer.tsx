        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">Hillside Journey</span>
            </Link>
            <p className="text-gray-400">
              Your gateway to authentic experiences in Meemure, Sri Lanka
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Phone: +94 77 353 8702</li>
              <li>Email: info@hillsidejourney.com</li>
              <li>Meemure Village, Kandy District</li>
              <li>Sri Lanka</li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Hillside Journey. All rights reserved.
            </p>
